...
import { updateSalesTracking } from "../../redux/transaction/transactionSlice";
...
function SalesTrack({ selected, showDetails, general, handleClose }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axios.patch(`/transactions/sales/${selected._id}`, formData, headerConfig);
      toast.success("Sales updated successfully!");
      const new_data = res.data.data
      dispatch(updateSalesTracking({
